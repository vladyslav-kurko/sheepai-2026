...
const CONTACT_ROWS = [
  {
    ...
    label: 'Phone',
    value: '+385 1 4567 890',
    href: 'tel:+38514567890',
  },
  {
    icon: 'M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6',
    label: 'Email',
    value: 'pisarnica@mup.hr',
    href: 'mailto:pisarnica@mup.hr',
  },
  {
    icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z M9 22V12h6v10',
    label: 'Address',
    value: 'Ulica grada Vukovara 33, Zagreb',
    href: 'https://maps.google.com',
  },
  {
    icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75',
    label: 'Dept.',
    value: 'MUP — Osobne iskaznice',
    href: undefined,
  },
];
...
export default function ContactCard() {
  return (
    <ModuleCard badge="Always shown" badgeVariant="always" icon={<PhoneIcon />} title="Contact">
      ...
      <button className="contact-book-btn">Book appointment online</button>
    </ModuleCard>
  );
}
